...
const s = StyleSheet.create({
  ...
  sourceBtn: { flex: 1, backgroundColor: colors.white, padding: 16, borderRadius: 20, borderWidth: 1, borderColor: colors.bg3, alignItems: 'center', ...shadow },
  ...
  uploadBtn: { height: 100, borderStyle: 'dashed', borderWidth: 2, borderColor: colors.bg3, borderRadius: 20, alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.bg },
  uploadBtnText: { fontSize: 13, fontWeight: '700', color: colors.ink2 },
  ttPreview: { padding: 14, backgroundColor: colors.g4, borderRadius: 16, borderWidth: 1, borderColor: colors.g2 },
  card: { backgroundColor: colors.white, borderRadius: 24, padding: 22, borderWidth: 1, borderColor: colors.bg3, ...shadow },
  cardTitle: { fontSize: 16, fontWeight: '800', color: colors.ink2, marginBottom: 16 },
