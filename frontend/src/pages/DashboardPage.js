  ...
  return (
    <div className="p-6 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="w-12 h-12 mb-5 bg-emerald-50 rounded-2xl flex items-center justify-center group-hover:bg-emerald-100 transition">
        ...
        <div
          ...
          className="group cursor-pointer rounded-2xl border border-violet-100 p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white"
        >
          <div className="w-12 h-12 mb-5 bg-violet-50 rounded-2xl flex items-center justify-center group-hover:bg-violet-100 transition">
          ...
          <button className="mt-6 text-sm font-bold text-violet-700 bg-violet-50 px-4 py-2 rounded-lg group-hover:bg-violet-100 transition">
            Upload Scheme →
          </button>
        </div>
        ...
        >
          <div className="w-12 h-12 mb-5 bg-blue-50 rounded-2xl flex items-center justify-center group-hover:bg-blue-100 transition">
