...
export default function Footer() {
  return (
    <footer className="w-full bg-white/70 dark:bg-black/70 backdrop-blur-md border-t border-gray-200 dark:border-white/10 pt-12 pb-8 mt-16 transition-colors duration-500">
